...
/**
Cette classe sert � la c�ration des GUI
...
public class LayoutPrincipal extends JFrame implements ActionListener {
	...
	//Cr�ation de l'arbre avec les mots du dictionnaire
	...
	public LayoutPrincipal() {
		...
		//D�but de l'op�ration avec le dictionnaire vide
		motActuel.setMot(' ');
	...
	/**
   	Cette m�thode est � l'affut de tous les evenements sur les boutons
    @param ActionEvent event
	*/
	@Override
	public void actionPerformed(ActionEvent event) {
		
		//Si le bouton enregistrer est cliqu�
		if (event.getSource() == btnEnregistrer) {
			try {
				//Deuxi�me panneau ouvre
				...
				//Mise � jour du dicitionnaire sleon le mot actuellement ecrit
				...
				//remise � 0 de la liste de droite avec les nouveaux mots
				String listeDroite ="";
		...
		if (event.getSource() == btnAjouter) {
			...
			try {
				...
				//Ajouter le fichier gr�ce � ajoutermotfichier
		...
		//Si le bouton charg� est cliqu�
		if (event.getSource() == btnCharger) {
			
			//Reprise des �tapes initiales avec un nouveau choix de fichier texte
	...
	/**
	 Cette classe sert � l'�couter clavier du mot tapp�
	 @author Philippe Meuser, Corentin Seguin
	 @version 1.0
	 @since 2020/12/06
	 */
	...
	/**
	 Cette classe sert � l'�couter clavier lorsque l'utlisateur choisi le nom de son fichier
	 @author Philippe Meuser, Corentin Seguin
	 @version 1.0
	 @since 2020/12/06
	 */
	public class MonEcouteurClavier2 implements KeyListener {
		...
		public void keyReleased(KeyEvent e) {
			...
			//Conditionn de fin du pannel
				...
				//Le nouveua nom du fichier s'allonge du caractere demand� par l'utlisateur
